...
typeof connectionString === 'string' ? mongoose_1.default.connect(connectionString) : null;
...
app.post('/users', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        email = req.userLogin.email.email;
        password = req.userLogin.password.password;
        try {
        }
        catch (error) {
            console.error(error);
